...
/*
    ...
    Engine::GetRoot()->Connect(new Platform(Vec2(710, 400), Vec2(5000, 200)));
    ...
    //Window::GetCamera()->SetViewport(Vec2(800, 600));

    btn = new Button(Engine::GetRoot(), Vec2(100, 20), Vec2(160, 64), "PressStart2P.ttf", 12);
    btn->SetStyle("pgui.png", Vec2(0,0), Vec2(24, 24), 8);
    btn->SetText("Button!\nBlaBlaBla");
    //btn->SetBackGround("pgui.png", Vec2(), 8);
}
